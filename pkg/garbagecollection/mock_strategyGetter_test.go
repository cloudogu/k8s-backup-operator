...
type mockConstructorTestingTnewMockStrategyGetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockStrategyGetter(t mockConstructorTestingTnewMockStrategyGetter) *mockStrategyGetter {
