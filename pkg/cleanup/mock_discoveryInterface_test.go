...
type mockConstructorTestingTnewMockDiscoveryInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDiscoveryInterface(t mockConstructorTestingTnewMockDiscoveryInterface) *mockDiscoveryInterface {
