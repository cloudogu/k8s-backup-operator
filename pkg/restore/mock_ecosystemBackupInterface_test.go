...
type mockConstructorTestingTnewMockEcosystemBackupInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockEcosystemBackupInterface(t mockConstructorTestingTnewMockEcosystemBackupInterface) *mockEcosystemBackupInterface {
