...
type mockConstructorTestingTnewMockVeleroInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockVeleroInterface(t mockConstructorTestingTnewMockVeleroInterface) *mockVeleroInterface {
