...
type mockConstructorTestingTnewMockVeleroBackupInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockVeleroBackupInterface(t mockConstructorTestingTnewMockVeleroBackupInterface) *mockVeleroBackupInterface {
