...
type mockConstructorTestingTnewMockBackupV1Alpha1Interface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockBackupV1Alpha1Interface(t mockConstructorTestingTnewMockBackupV1Alpha1Interface) *mockBackupV1Alpha1Interface {
