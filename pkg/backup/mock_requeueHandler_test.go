...
func (_m *mockRequeueHandler) Handle(ctx context.Context, contextMessage string, backup v1.RequeuableObject, originalErr error, requeueStatus string) (reconcile.Result, error) {
...
func (_c *mockRequeueHandler_Handle_Call) Run(run func(ctx context.Context, contextMessage string, backup v1.RequeuableObject, originalErr error, requeueStatus string)) *mockRequeueHandler_Handle_Call {
