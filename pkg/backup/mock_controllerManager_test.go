...
import (
	...
	internal "k8s.io/client-go/tools/events"
...
func (_m *mockControllerManager) GetConverterRegistry() conversion.Registry {
	ret := _m.Called()
...
// mockControllerManager_GetConverterRegistry_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetConverterRegistry'
type mockControllerManager_GetConverterRegistry_Call struct {
	*mock.Call
}

// GetConverterRegistry is a helper method to define mock.On call
func (_e *mockControllerManager_Expecter) GetConverterRegistry() *mockControllerManager_GetConverterRegistry_Call {
	return &mockControllerManager_GetConverterRegistry_Call{Call: _e.mock.On("GetConverterRegistry")}
}

func (_c *mockControllerManager_GetConverterRegistry_Call) Run(run func()) *mockControllerManager_GetConverterRegistry_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockControllerManager_GetConverterRegistry_Call) Return(_a0 conversion.Registry) *mockControllerManager_GetConverterRegistry_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockControllerManager_GetConverterRegistry_Call) RunAndReturn(run func() conversion.Registry) *mockControllerManager_GetConverterRegistry_Call {
	_c.Call.Return(run)
	return _c
}

// GetEventRecorder provides a mock function with given fields: name
func (_m *mockControllerManager) GetEventRecorder(name string) internal.EventRecorder {
	ret := _m.Called(name)
...
// mockControllerManager_GetEventRecorder_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetEventRecorder'
type mockControllerManager_GetEventRecorder_Call struct {
	*mock.Call
}

// GetEventRecorder is a helper method to define mock.On call
//   - name string
func (_e *mockControllerManager_Expecter) GetEventRecorder(name interface{}) *mockControllerManager_GetEventRecorder_Call {
	return &mockControllerManager_GetEventRecorder_Call{Call: _e.mock.On("GetEventRecorder", name)}
}

func (_c *mockControllerManager_GetEventRecorder_Call) Run(run func(name string)) *mockControllerManager_GetEventRecorder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *mockControllerManager_GetEventRecorder_Call) Return(_a0 internal.EventRecorder) *mockControllerManager_GetEventRecorder_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockControllerManager_GetEventRecorder_Call) RunAndReturn(run func(string) internal.EventRecorder) *mockControllerManager_GetEventRecorder_Call {
	_c.Call.Return(run)
	return _c
}
