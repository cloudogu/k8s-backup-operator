...
type mockConstructorTestingTnewMockBackupScheduleClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockBackupScheduleClient(t mockConstructorTestingTnewMockBackupScheduleClient) *mockBackupScheduleClient {
