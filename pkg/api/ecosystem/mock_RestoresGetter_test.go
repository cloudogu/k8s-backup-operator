...
type mockConstructorTestingTNewMockRestoresGetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRestoresGetter(t mockConstructorTestingTNewMockRestoresGetter) *MockRestoresGetter {
