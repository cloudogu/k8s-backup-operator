...
type mockConstructorTestingTNewMockBackupSchedulesGetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockBackupSchedulesGetter(t mockConstructorTestingTNewMockBackupSchedulesGetter) *MockBackupSchedulesGetter {
