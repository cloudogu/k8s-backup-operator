...
type mockConstructorTestingTNewMockRequeueableStatus interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRequeueableStatus(t mockConstructorTestingTNewMockRequeueableStatus) *MockRequeueableStatus {
