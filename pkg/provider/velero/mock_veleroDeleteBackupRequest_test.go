...
type mockConstructorTestingTnewMockVeleroDeleteBackupRequest interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockVeleroDeleteBackupRequest(t mockConstructorTestingTnewMockVeleroDeleteBackupRequest) *mockVeleroDeleteBackupRequest {
