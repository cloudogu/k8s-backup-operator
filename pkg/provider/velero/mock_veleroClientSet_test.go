...
type mockConstructorTestingTnewMockVeleroClientSet interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockVeleroClientSet(t mockConstructorTestingTnewMockVeleroClientSet) *mockVeleroClientSet {
