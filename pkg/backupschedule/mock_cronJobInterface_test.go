...
type mockConstructorTestingTnewMockCronJobInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockCronJobInterface(t mockConstructorTestingTnewMockCronJobInterface) *mockCronJobInterface {
