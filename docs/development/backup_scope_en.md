...
Because the restore process will delete and recreate those resources, any Deployments, StatefulSets, ReplicaSets, ReplicationControllers or DaemonSets that mount them have to be scaled down to zero.
